...
Widget novaButtonCatalog(BuildContext context) {
  ...
  final appendIcon = hasAppendIcon ? const Icon(Icons.arrow_forward) : null;

  final prependIcon = hasPrependIcon ? const Icon(Icons.arrow_back) : null;
  ...
  return Center(
    child: NovaButton(
      variant: buttonType,
      size: buttonSize,
      onPressed: buttonState == 'Disabled' ? null : () {},
      child: Row(
